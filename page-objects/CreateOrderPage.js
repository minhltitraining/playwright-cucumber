...
exports.CreateOrderPage = class CreateOrderPage extends AbstractPage {
    ...
    constructor(page = Page) {
        ...
        this.processBtn = page.locator('text=Process')
        ...
        this.invalidZipErr = page.locator("//span[normalize-space()='Invalid format. Only digits allowed.']");
    ...
    async createOrder(quantity, name, street, city, zipcode, card, cardNr, expDate) {
        this.txtQuantity.fill(quantity);
        this.txtName.fill(name);
        this.txtStreet.fill(street);
        this.txtCity.fill(city);
        this.txtZipcode.fill(zipcode);
        if (card) {
            this.page.locator("//input[@value='" + card + "']").click();
        }
        this.txtCardNr.fill(cardNr);
        this.txtExpDate.fill(expDate);
    }
    ...
    async assertResult(expResult) {
        ...
        switch (expResult) {
            case "valid":
                ...
                break;
            case "empty_quantity":
                expect(this.emptyQuantityErr).toBeVisible();
                break;
